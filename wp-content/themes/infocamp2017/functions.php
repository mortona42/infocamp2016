<?php
/**
 * InfoCamp2017 functions and definitions
 *
...
function infocamp2017_setup() {
	 ...
	 * If you're building a theme based on InfoCamp2017, use a find and replace
	...
	register_nav_menus( array(
		'menu-1' => esc_html__( 'Primary', 'infocamp2017' ),
	) );
...
function infocamp2017_widgets_init() {
	register_sidebar( array(
		...
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'infocamp2017' ),
